...
export default function RoofReplacementPage() {
  ...
  const replacementFAQs = [
    ...
    },
    {
      ...
      answer: "Most residential roof replacements take 1-2 days depending on size, weather, and complexity. We work efficiently to minimize disruption to your daily routine."
    },
    {
      ...
      <section className="bg-black py-16">
        <div className="mx-auto w-[min(1200px,94%)]">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Our Roof Replacement Process</h2>
            ...
            <div className="md:hidden flex items-center justify-center mt-8 mb-8 px-4">
              <button 
                onClick={() => setActiveProcess(activeProcess === 'insurance' ? 'retail' : 'insurance')}
          ...
          <div className={`grid md:grid-cols-2 lg:grid-cols-4 gap-8 ${activeProcess === 'insurance' ? '' : 'hidden'}`}>
            ...
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur rounded-xl p-6 border border-white/15 mb-4 h-full flex flex-col">
                ...
                <h3 className="text-lg font-bold text-white mb-3">Complete Replacement</h3>
                <p className="text-slate-300 text-sm flex-grow">
                  Full tear-off and professional installation of your new roof system. Licensed craftsmen with daily progress updates throughout the 1-2 day process.
                </p>
              </div>
            </div>
          ...
          {/* Retail Process */}
          <div className={`grid md:grid-cols-2 lg:grid-cols-4 gap-8 ${activeProcess === 'retail' ? '' : 'hidden'}`}>
            {/* Step 1 */}
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur rounded-xl p-6 border border-white/15 mb-4 h-full flex flex-col">
                <div className="bg-yellow-500 text-black rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 font-bold text-xl">1</div>
                ...
                <p className="text-slate-300 text-sm flex-grow">
                  Comprehensive roof assessment with detailed photos and condition report. Honest evaluation of replacement needs and material recommendations.
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur rounded-xl p-6 border border-white/15 mb-4 h-full flex flex-col">
                <div className="bg-yellow-500 text-black rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 font-bold text-xl">2</div>
                <h3 className="text-lg font-bold text-white mb-3">Material Selection</h3>
                <p className="text-slate-300 text-sm flex-grow">
                  Choose from quality roofing materials and colors. Detailed written estimate with specifications, timeline, and warranty information. No hidden fees.
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur rounded-xl p-6 border border-white/15 mb-4 h-full flex flex-col">
                ...
                <h3 className="text-lg font-bold text-white mb-3">Complete Replacement</h3>
                <p className="text-slate-300 text-sm flex-grow">
                  Full tear-off and professional installation by licensed, insured craftsmen. We handle permits and coordinate for minimal disruption.
                </p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-white/10 backdrop-blur rounded-xl p-6 border border-white/15 mb-4 h-full flex flex-col">
                ...
                <p className="text-slate-300 text-sm flex-grow">
                  Thorough cleanup with magnetic nail sweep, debris removal, and final walkthrough inspection with comprehensive warranty documentation.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-8 shadow-2xl hover:bg-white/15 transition-all duration-300 group border border-white/15">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 leading-relaxed">Our experienced crews work efficiently to complete most residential replacements in 1-2 days, minimizing disruption while maintaining the highest quality standards.</p>
                </div>
              </div>
            </div>
