...
import FlatRoofingClient from "./FlatRoofingClient";
      ...
      <section className="bg-black py-16">
        <div className="mx-auto w-[min(1200px,94%)]">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur rounded-xl p-6 border border-white/15">
              <div className="bg-blue-600 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 460 390">
                  <g>
                    <g>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-12 pt-8 border-t border-zinc-700">
              <p className="text-slate-300 mb-4">
                Have more questions? We're here to help with all your flat roofing needs.
              </p>
              <button
                onClick={() => {
